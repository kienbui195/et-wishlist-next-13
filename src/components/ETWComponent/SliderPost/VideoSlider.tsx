...
const VideoSlider: FC<VideoSliderProps> = ({
  ...
  return (
    <div
      className={`nc-VideoSlider w-full h-[315px] border-b border-gray-2400 pt-5 `}
    >
      <div className="flex justify-between items-center">
        ...
        <Link
          to="/videos"
          className="border-b border-black showAll cursor-pointer text-[--gray-text]"
        >
          Show all
        </Link>
      </div>
      ...
      <div
        className="group/videos nc-MySlider w-full h-[230px] pt-5 flex space-x-4 overflow-x-scroll md:overflow-hidden relative"
        id="videosPrdDetailSlider"
      >
        <MotionConfig
          transition={{
        ...
        >
          <div className={`relative flow-root`} {...handlers}>
            <div className={`flow-root overflow-hidden`}>
              <motion.ul
                initial={false}
                className="relative whitespace-nowrap flex space-x-[18px]"
              >
