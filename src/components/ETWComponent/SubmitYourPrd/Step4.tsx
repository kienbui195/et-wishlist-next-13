  ...
  return (
    <main className="w-full flex-1">
      <div className="mt-8">
        ...
        <div className="mt-[9px] text-base font-semibold leading-none text-green-1450">4 of 4 </div>
        <h1 className="mt-[35px] text-xl font-semibold leading-none text-black">Show us your product.</h1>
      ...
      <div className="flex">
        <div className="w-full max-w-[240px]">
          ...
          <div className="mt-[22px] text-sm leading-normal text-gray-2050">
            <p className="mb-0.5 font-semibold text-slate-950">Logo Requirements</p>
            <p>Min. Size - 400x400px.</p>
            <p>Ensure image is centered in frame.</p>
            <p>Max. File Size - 10mb</p>
          </div>
        </div>
        <div className="el-divider el-divider--vertical mx-[30px] h-[370px] border-gray-1350" role="separator"></div>
        <div className="w-full max-w-[935px]">
          ...
          <div className="relative mt-3 flex min-h-[390px] w-full flex-col items-center justify-start rounded-md border border-gray-1350 bg-gray-2150 px-[23px] py-5">
            <div className="mb-[25px] mt-auto text-center text-sm leading-normal text-gray-2050">
              <p className="mb-0.5 font-semibold text-slate-950"> Image Requirements </p>
            ...
            <button className="flex min-h-[39px] items-center rounded bg-green-950 px-[18px] py-2.5 text-base font-semibold leading-[19px] text-white absolute left-1/2 top-1/2 z-20 -translate-x-1/2 -translate-y-1/2 transform whitespace-nowrap">
              <Image src="https://d22lwxpnhu2n4a.cloudfront.net/grommet/img/plus.svg" alt="" width="10" height="10" className="mr-2" /> Add Image(s)
            </button>
          </div>
        </div>
        <div className="el-divider el-divider--vertical mx-[30px] h-[370px] border-gray-1350" role="separator"></div>
        <div className="w-full max-w-[300px]">
          <div className="text-sm font-medium leading-none text-slate-1050"> Video </div>
          <div className="relative mt-3 flex min-h-[390px] w-full max-w-[240px] flex-col items-center justify-end rounded-md border border-gray-1350 bg-gray-2150 p-5">
            <button className="flex min-h-[39px] items-center rounded bg-green-950 px-[18px] py-2.5 text-base font-semibold leading-[19px] text-white absolute left-1/2 top-1/2 z-10 -translate-x-1/2 -translate-y-1/2 transform whitespace-nowrap">
              <Image src="https://d22lwxpnhu2n4a.cloudfront.net/grommet/img/plus.svg" alt="" width="10" height="10" className="mr-2" /> Add Video
            </button>
            <div className="mb-1 mt-auto text-center text-sm leading-normal text-gray-2050">
              <p className="mb-0.5 font-semibold text-slate-950"> Video Requirements </p>
      ...
      <div className="mt-10 flex">
        ...
        >
          <span className="text-lg font-semibold text-white">Complete Application</span>
        </button>
        <button
      ...
      <ETModal open={openModal} onClose={() => setOpenModal(false)}>
        <div className={"p-[21px_18px]"}>
          <header className="el-dialog__header">
            <button aria-label="Close this dialog" className="el-dialog__headerbtn" type="button">
              <i className="el-icon el-dialog__close" onClick={() => setOpenModal(false)}>
          ...
          <div id="el-id-4996-281" className="el-dialog__body">
            <div className="text-sm font-semibold leading-none text-slate-1100">Upload Images</div>
            <div className="mt-2.5 text-xs font-normal leading-none text-gray-2050"> Attach and upload your files below</div>
            <div className="upload-media mt-4">
              <div className="el-upload el-upload--text is-drag ">
                ...
                <input className="el-upload__input" name="file" accept="image/*" type="file" />
