...
import MainImage from 'assets/svg/Step3-image.svg'
      ...
      <div className="fixed inset-x-0 inset-y-20 flex items-center justify-center">
        <div className="mx-auto w-full max-w-[316px] rounded-xl bg-white px-7 py-6 text-center shadow-appSubmit">
          <img
            ...
            width="50"
            height="50"
            className="mx-auto aspect-square rounded-lg object-cover hidden"
          />
          <h1 className="text-base font-medium text-slate-1100">
            Application Submitted
          </h1>
          <p className="mt-2 text-xs font-normal text-gray-1150">
            Check your e-mail for a receipt of your application and the next
            steps that you can expect.
          </p>
          <p className="mt-2 text-xs font-semibold leading-tight text-black">
            Want to get ahead and be ready for launch?
          </p>
