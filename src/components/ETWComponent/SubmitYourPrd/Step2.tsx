...
const Step2: FC<Step2Props> = ({ nextStep, backStep }) => {
  ...
  const handleSubmit = () => {
    const token = localStorage.getItem("ETWL") && JSON.parse(localStorage.getItem("ETWL") || "");
  ...
  const handleGetShop = () => {
    ...
    apis
      ...
      .catch((err) => {
        ...
        router.push("/submit-your-product");
      });
  };
  ...
  return (
    <main className="w-full flex-1">
      <div className="mt-8">
        ...
        <div className="mt-[9px] text-base font-semibold leading-none text-green-1450">2 of 3 </div>
        {/*<div className='mt-[9px] text-base font-semibold leading-none text-green-1450'>*/}
        {/*  2 of 4{' '}*/}
        {/*</div>*/}
        <h1 className="mt-[35px] text-xl font-semibold leading-none text-black">Tell us about your company.</h1>
        <h2 className="mt-2.5 text-sm leading-tight text-gray-1150">
          {" "}
          Shopper security is a top priority at Wishlist. We want to ensure that every product that launches on our platform is by a verified company. Please
          enter your company information below to continue with your application.{" "}
        </h2>
      ...
      <form className="el-form el-form--default el-form--label-top flex">
        <div className="max-w-[555px] grow">
          <div className="text-lg font-semibold leading-tight text-gray-1050"> Company Details </div>
          <FormInput
            placeholder="Enter Company Name"
            label="Company Name"
            required
            hint={"This should be your official company name, inclusive of suffix (LLC,Inc, etc.)"}
            error={errors.name !== ""}
          ...
          <SingleSelect
            ...
            hint={"If multiple, select your principle country of incorporation."}
            onChange={(val) => {
        ...
        <div className="max-w-[555px] grow">
          <div className="text-lg font-semibold leading-tight text-gray-1050"> Company Address </div>
