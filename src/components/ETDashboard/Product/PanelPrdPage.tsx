...
const PanelPrdPage: React.FC<ProductPanelProps> = ({ data, onSetState, isCreate = true, errors }) => {
  ...
  return (
    <div id="pane-Product Page" className="el-tab-pane" role="tabpanel" aria-hidden="true" aria-labelledby="tab-Product Page">
      <div product-form-ref="[object Object]">
        <div>
          <h2 className="mt-[25px] text-sm font-medium leading-none tracking-tight text-black">Build Your Product Page</h2>
          <h3 className="mt-2.5 text-base leading-tight text-gray-1150">
            ...
            <Link href="/">
              <span className="cursor-pointer text-green-950 underline decoration-solid">Click here to view an example.</span>
            </Link>
          </h3>
        </div>
        <div className="mt-[30px] flex">
          ...
          <div className="w-full max-w-[520px]">
            <p className="mb-3 text-xs font-medium leading-none text-slate-1050">Why You’ll Love It</p>
            <p className="mt-2.5 text-base text-gray-1150">Add up to 5 reasons why Shoppers will love having your product.</p>
