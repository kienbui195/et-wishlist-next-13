...
const CompanyPanel: React.FC<CompanyPanelProps> = ({ company, country, onChange, onChangeImg, errors }) => {
      ...
      <div className="el-form el-form--default el-form--label-top mt-2.5 max-w-[555px]">
        ...
        <div className="el-form-item is-required asterisk-right mt-5">
          ...
          <div className="mt-5">
            <Image
              ...
              src={company.logo?.url !== "" ? imageUrl : "./default-thumbnail-md.jpg"}
        ...
        <div className="el-form-item is-required asterisk-right mt-5">
          ...
          <SingleSelect
            ...
            onChange={(e) => {
              onChange && onChange({ target: { value: e.name } }, "business_in_country");
            }}
        ...
        <div className="mt-[30px] text-lg font-semibold leading-tight text-gray-1050">Company Address</div>
