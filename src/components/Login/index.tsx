...
const LoginModal: FC<LoginProps> = ({ open = false, onClose }) => {
  ...
  return (
    <Modal onClose={handleClose} className="!p-0" classNameContainer="!mt-[150px]">
      <div
        className={`w-full ${mediaQueryWidth > 900 ? "w-[900px]" : "w-fit"} h-fit bg-white shadow-[0_4px_20px_0_--modal-shadow] rounded-3xl box-border flex`}
      >
